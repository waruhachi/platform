...
export function AppDetails() {
    ...
    return (_jsxs(Box, { flexDirection: "column", padding: 1, children: [_jsx(Panel, { title: "\uD83D\uDCCB Application Details", variant: "info", children: _jsxs(Box, { flexDirection: "column", gap: 1, children: [_jsxs(Text, { children: [_jsx(Text, { color: "gray", children: "Name: " }), _jsx(Text, { bold: true, children: app.name })] }), _jsxs(Text, { children: [_jsx(Text, { color: "gray", children: "Status: " }), getStatusEmoji(app.deployStatus), ' ', _jsx(Text, { color: getStatusColor(app.deployStatus), bold: true, children: app.deployStatus })] }), _jsxs(Text, { children: [_jsx(Text, { color: "gray", children: "Mode: " }), _jsx(Text, { bold: true, children: "\uD83C\uDF10 HTTP Server" })] }), app.recompileInProgress && (_jsx(Box, { marginTop: 1, children: _jsx(Text, { color: "yellow", children: "\u26A1\uFE0F Application is recompiling..." }) }))] }) }), _jsx(Box, { marginTop: 2, children: _jsx(InfiniteFreeText, { successMessage: "Changes applied successfully", question: "How would you like to modify your app?", placeholder: "e.g., Add a new feature, modify behavior, or type 'exit' to finish", onSubmit: (text) => generateAppIteration({
                        prompt: text,
                        ...app,
                        useStaging: false,
