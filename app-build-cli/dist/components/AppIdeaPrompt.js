...
export const AppIdeaPrompt = () => {
    ...
    return (_jsx(Box, { flexDirection: "column", padding: 1, borderStyle: "round", borderColor: "green", children: _jsxs(Box, { flexDirection: "column", children: [_jsxs(Box, { children: [_jsx(Text, { children: "App Description: " }), _jsx(Text, { color: "green", children: appIdea.description })] }), _jsxs(Box, { flexDirection: "column", marginTop: 1, children: [_jsx(Text, { children: "Selected Features:" }), appIdea.features?.map((feature) => (_jsx(Box, { marginLeft: 1, children: _jsxs(Text, { color: "green", children: ["\u2022 ", feature.label] }) }, feature.value)))] }), _jsxs(Box, { marginTop: 1, children: [_jsx(Text, { children: "Database: " }), _jsx(Text, { color: appIdea.hasDatabase ? 'green' : 'red', children: appIdea.hasDatabase ? 'Yes' : 'No' })] })] }) }));
};
//# sourceMappingURL=AppIdeaPrompt.js.map